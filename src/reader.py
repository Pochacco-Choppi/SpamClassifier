...
class DSReader:
    ...
    def dataset_cleaning(dataset):
        ...
        dataset.to_lower()
        dataset.remove_digits()
        dataset.remove_punctuation_marks()
        dataset.remove_duplicates()
        dataset.remove_stopwords()
    ...
    def vectorize(self):
        ...
        logging.info('Dataset successful split(vectorize)!')
    ...
    def split_train_and_test(list_email, list_label, percent=0.7):
        ...
        logging.info('Dataset successful split!')
